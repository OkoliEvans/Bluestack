...
import "../interfaces/IStacksToken.sol";
import "../../lib/openzeppelin-contracts/contracts/utils/math/SafeMath.sol";

contract BluestacksLaunchPad {
    ...
    function WithdrawLaunchPadToken() public {
        ...
        bool success = transfer_(IStacksToken(padToken), reward, msg.sender);
    ...
    function swapLaunchPadTokenToEther(uint _amount) public {
        ...
        transferFrom_(IStacksToken(padToken), _amount, msg.sender);
    ...
    function withdrawPadToken_Admin(uint _amount) public OnlyModerator {
        ...
        bool success = transfer_(IStacksToken(padToken), _amount, msg.sender);
    ...
    function participateInPresale() public payable {
        ...
        bool success = IStacksToken(padToken).transfer(msg.sender, tokenReceived);
